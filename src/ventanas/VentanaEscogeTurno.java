 ...
 * @author perez
 */
public class VentanaEscogeTurno extends javax.swing.JDialog {

    private String usuario1, usuario2;
    private String turno;
    
    /**
     * Creates new form VentanaQuienJuega
     */
    public VentanaEscogeTurno(java.awt.Frame parent, boolean modal, String usuario1, String usuario2) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEscogeTurno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaEscogeTurno dialog = new VentanaEscogeTurno(new javax.swing.JFrame(), true, null, null);
